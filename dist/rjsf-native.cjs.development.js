...
var FieldTemplate = function FieldTemplate(_ref) {
  ...
  }), (rawHelp == null ? void 0 : rawHelp.length) > 0 && React__default.createElement(reactNative.Text, {
...
var ObjectFieldTemplate = function ObjectFieldTemplate(_ref) {
  ...
  return React__default.createElement(reactNative.View, null, uiSchema['ui:title'] || title ? React__default.createElement(RootTitleField, {
...
var getUiOptions = core.utils.getUiOptions,
    ...
    getDefaultFormState = core.utils.getDefaultFormState,
    getMatchingOption = core.utils.getMatchingOption;
...
var UnsupportedField = function UnsupportedField(_ref) {
  ...
  }, "Unsupported field schema for field ", React__default.createElement(reactNative.Text, {
    style: styles$c.fieldId
  }, idSchema == null ? void 0 : idSchema.$id), ": ", React__default.createElement(reactNative.Text, {
    style: styles$c.reason
  }, reason)), React__default.createElement(reactNative.View, {
    style: styles$c.schemaContainer
  }, schema && ((_Object$keys = Object.keys(schema)) == null ? void 0 : _Object$keys.length) > 0 && React__default.createElement(reactNative.Text, {
    style: styles$c.alignment
  }, pseudoFormatSchema(schema))));
};

var styles$c = /*#__PURE__*/reactNative.StyleSheet.create({
  fieldId: {
